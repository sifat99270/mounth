    ...
    <div className="w-screen">
      ...
      <div className="w-screen flex justify-evenly items-center ">
        <input
          value={data.name}
          type="text"
          className="w-40 bg-slate-200 outline-none  border-solid border-sky-400 p-2 rounded-md border focus:border-teal-300 shadow-md shadow-gray-500"
          placeholder="name"
          onChange={(e) => {
        ...
        <input
          value={data.hazira}
          type="text"
          className="w-36 bg-slate-200 outline-none  border-solid border-sky-400 p-2 rounded-md border focus:border-teal-300 shadow-md shadow-gray-500"
          placeholder="hazira"
          onChange={(e) => {
